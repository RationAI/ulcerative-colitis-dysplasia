...
**Repository:** `ulcerative-colitis-dysplasia` (RationAI)
**Context:** This is a research-focused machine learning repository dedicated to segmentation of dysplasia in colon WSIs in digital pathology. 
